...
let songIndex = 0;
let audioElement = new Audio("song8/1.mp3");
...
let songs = [
    { songName: "Dil Toh Pagal Hain – Dil Toh Pagal Hain (Lata Mangeshkar)", coverPath: "cover8/1.jpg"},
    { songName: "Janam Janam Ke Saath – Bheegi Palkein(Lata Mangeshkar)", coverPath: "cover8/2.jpg"},
    { songName: "Tere Bina Zindagi Se - Aandhi (Lata Mangeshkar)", coverPath: "cover8/3.jpg"},
    { songName: "Bheegi Bheegi Raaton Mein - Ajnabee(Lata Mangeshkar)", coverPath: "cover8/4.jpg"},
    { songName: "Kora Kagaz Tha Yeh Man Mera - Aradhana(Lata Mangeshkar)", coverPath: "cover8/5.jpg"},
    { songName: "Agar Tum Na Hote – Collection Of Lata Mangeshkar(Lata Mangeshkar)", coverPath: "cover8/6.jpg"},
    { songName: "Tujh Snag Preet Lagai Sanjna - Kaamchor(Lata Mangeshkar)", coverPath: "cover8/7.jpg"},
    { songName: "Dil Pardeshi Ho Gaya – Kachche Dhaage(Lata Mangeshkar)", coverPath: "cover8/8.jpg"},
    { songName: "Laag Ja Gaale Se – Who Kaun Thi (Lata Mangeshkar)", coverPath: "cover8/9.jpg"},
    { songName: "Pardesia Yeh Sach Hai – Mr Natwarlaal (Lata Mangeshkar)", coverPath: "cover8/10.jpg"},
]
...
Array.from(document.getElementsByClassName('songItemPlay')).forEach((element) => {
    element.addEventListener('click', (e) => {
        ...
        audioElement.src = `song8/${songIndex + 1}.mp3`;
        songPic.src = `cover8/${songIndex + 1}.jpg`;
